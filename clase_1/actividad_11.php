...
for ($mes; $mes <=12; $mes++){
    ...
    if ($mes >=4 & $mes < 7){ // el mes debe estar entre abril y junio (4 a 6)
        echo "La estación es otoño";
        echo "<br>";
    }
    
    if ($mes >=7 & $mes < 10){ // el mes debe estar entre julio y septiembre (de 7 a 9)
        echo "La estación es invierno";
        echo "<br>";
    }
    
    if ($mes >=10 & $mes <= 12){ // el mes debe estar entre octubre y diciembre (10 a 12)
